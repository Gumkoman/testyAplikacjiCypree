const { min, max } = require("cypress/types/lodash")

describe('PBG Rejestracja', () => {

    const emailName = 'autotestycp+'
    const emailEnd = '@gmail.com'
    // const emailNumber = min='20' max='999999999'
    ...
    it('3. Użytkownik uzupełnia wszystkie potrzebne dane...', () => {
        ...
        cy.get('input[placeholder="E-mail"]').type (emailName + emailNumber + emailEnd)   
